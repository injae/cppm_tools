macro(download_package)
    ...
    if(ARG_GLOBAL)
      set(CMAKE_INSTALL_PREFIX "")
        ...
        if(_is_git)
            set(CMAKE_INSTALL_PREFIX "${HOME}/.cppm/local/${name}")
        else()
            set(CMAKE_INSTALL_PREFIX "${HOME}/.cppm/local/${name}-${version}")
        endif()
    endif()
    ...
    if(_is_not_found OR _is_git)
        ...
        if(NOT hash_matched)
            ...
            #file(COPY ${_binaries_} DESTINATION ${CPPM_INSTALL_PREFIX}/local/bin FOLLOW_SYMLINK_CHAIN)
            if(_is_git)
