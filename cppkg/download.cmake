macro(download_package)
    ...
    if(ARG_GLOBAL)
      set(CMAKE_INSTALL_PREFIX "")
        ...
        if(_is_git)
            set(CMAKE_INSTALL_PREFIX "${HOME}/.cppm/local/share/${name}")
        else()
            set(CMAKE_INSTALL_PREFIX "${HOME}/.cppm/local/share/${name}-${version}")
        endif()
    endif()
    ...
    if(_is_not_found OR _is_git)
        ...
        if(NOT hash_matched OR (NOT EXISTS ${_binary_directory}))
