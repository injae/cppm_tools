...
macro(_cppm_compiler_debug_option)
    ...
    if(NOT "${cppm_build_type}" STREQUAL "debug")
        if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
            add_compiler_option(CMAKE_CXX_FLAGS "-Wall -fPIC -O0 -g")
            add_compiler_option(CMAKE_CXX_FLAGS "${ARG_CLANG}")
        elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
            add_compiler_option(CMAKE_CXX_FLAGS "-Wall -fPIC -O0 -g")
            add_compiler_option(CMAKE_CXX_FLAGS "${ARG_GCC}")
        elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
            add_compiler_option(CMAKE_CXX_FLAGS "/DWIN32 /D_WINDOWS /MP /Zi /Ob0 /Od /EHsc")
            add_compiler_option(CMAKE_CXX_FLAGS "${ARG_MSVC}")
...
macro(_cppm_compiler_release_option)
    ...
    if("${cppm_build_type}" STREQUAL "release")
        if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
            add_compiler_option(CMAKE_CXX_FLAGS "-fPIC -O3 -DNDEBUG")
            add_compiler_option(CMAKE_CXX_FLAGS "${ARG_CLANG}")
        elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
            add_compiler_option(CMAKE_CXX_FLAGS "-fPIC -O3 -DNDEBUG")
            add_compiler_option(CMAKE_CXX_FLAGS "${ARG_GCC}")
        elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
            add_compiler_option(CMAKE_CXX_FLAGS "/DWIN32 /D_WINDOWS /MP /O2 /EHsc")
            add_compiler_option(CMAKE_CXX_FLAGS "${ARG_MSVC}")
        elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "AppleClang")
        endif()
    endif()
