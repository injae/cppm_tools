...
macro(_cppm_compiler_debug_option)
    ...
    if(NOT "${CMAKE_BUILD_TYPE}" STREQUAL "Release")
        ...
        if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
            set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} ${DEF_CLANG_OPT} ${ARG_CLANG} CACHE STRING "compiler flags")
            #add_compile_options(${DEF_CLANG_OPT} ${ARG_CLANG})
        elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
            set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} ${DEF_GCC_OPT} ${ARG_GCC} CACHE STRING "compiler flags")
            #add_compile_options(${DEF_GCC_OPT}   ${ARG_GCC})
        elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
            set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} ${DEF_MSVC_OPT} ${ARG_MSVC} CACHE STRING "compiler flags")
