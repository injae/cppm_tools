...
macro(_cppm_compiler_debug_option)
    ...
    if(NOT DEFINED ARG_CLANG)
        set(ARG_CLANG "-Wall -fPIC -O0 -g -std=c++17")
    endif()
    if(NOT DEFINED ARG_GCC)
        set(ARG_GCC  "-Wall -fPIC -O0 -g -std=c++17")
    endif()
    if(NOT DEFINED ARG_MSVC)
        set(ARG_MSVC "/std:c++17 /MP /MDd /Zi /Ob0 /Od /RT1")
    endif()
...
macro(_cppm_compiler_release_option)
    ...
    if(NOT DEFINED ARG_CLANG)
        set(ARG_CLANG "-fPIC -03 -DNDEBUG -std=c++17")
    endif()
    if(NOT DEFINED ARG_GCC)
        set(ARG_GCC  "-fPIC -O3 -DNDEBUG -std=c++17")
    endif()
    if(NOT DEFINED ARG_MSVC)
        set(ARG_MSVC "/std:c++17 /MP /MD /Zi /O2 /DNDEBUG")
    endif()
