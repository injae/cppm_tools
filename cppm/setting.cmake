...
macro(_cppm_set_prefix)
    ...
    if(cppm_build_type STREQUAL "release" OR (NOT cppm_generator_type STREQUAL "visual"))
        ...
        list(APPEND CMAKE_PREFIX_PATH    "${CPPM_PKGS}/debug" "${CPPM_PKGS}" "${CPPM_ROOT}")
        list(APPEND CMAKE_LIBRARY_PATH   "${CPPM_PKGS}/debug" "${CPPM_PKGS}" "${CPPM_ROOT}")
        list(APPEND CMAKE_FIND_ROOT_PATH "${CPPM_PKGS}/debug" "${CPPM_PKGS}" "${CPPM_ROOT}")
