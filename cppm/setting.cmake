macro(_cppm_setting)
  ...
  if(NOT ${CMAKE_PROJECT_NAME} MATCHES ${PROJECT_NAME})
      set(SUB_PROJECT TRUE PARENT_SCOPE)
      set(NO_MESSAGE TRUE PARENT_SCOPE)
  else()
      set(SUB_PROJECT FALSE PARENT_SCOPE)
      set(NO_MESSAGE FALSE PARENT_SCOPE)
  endif()
  if(ARG_NO_MESSAGE)
      set(NO_MESSAGE TRUE)
  endif()
  ...
  list(APPEND CMAKE_PREFIX_PATH "${HOME}/.cppm/local/lib64/cmake")
  list(APPEND CMAKE_PREFIX_PATH "${HOME}/.cppm/local/lib/pkgconfig")
  list(APPEND CMAKE_PREFIX_PATH "${HOME}/.cppm/local/lib64/pkgconfig")
