function(cppm_target_define)
    ...
    cppm_set_if_else(_public_header  "include"                       "ARG_PUBLIC_HEADER"  "${ARG_PUBLIC_HEADER}")
    cppm_set_if_else(_private_header "src"                           "ARG_PRIVATE_HEADER" "${ARG_PRIVATE_HEADER}")
    cppm_set_if_else(_namespace      "${CMAKE_PROJECT_NAME}"         "ARG_NAMESPACE"      "${ARG_NAMESPACE}")
    cppm_set_if_else(_optional       "${CMAKE_PROJECT_NAME}_${name}" "ARG_OPTIONAL"       "${ARG_OPTIONAL}")

    if(_optional AND ARG_EXCLUDE)
