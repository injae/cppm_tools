        ...
        if(_target_type MATCHES "BINARY")
            ...
            if(PACKAGE_PREFIX_DIR STREQUAL "${CPPM_PREFIX}")
                add_custom_command(TARGET ${name} POST_BUILD COMMAND
                    ${CMAKE_COMMAND} -E create_symlink "$<INSTALL_PREFIX>$<TARGET_FILE_BASE_NAME:${name}>" "${CPPM_PREFIX}/bin/$<TARGET_FILE_BASE_NAME:${name}>" COMMENT "-- Linking ${CMAKE_INSTALL_PREFIX}/bin -> ${CPPM_PREFIX}/bin/")
