    ...
    if(TARGET ${name})
        ...
        if(_target_type MATCHES "BINARY")
            ...
            if(PACKAGE_PREFIX_DIR STREQUAL "${CPPM_PREFIX}")
                add_custom_command(${name} COMMAND ${CMAKE_COMMAND} -E create_symlink "${CMAKE_INSTALL_PREFIX}/bin/$<TARGET_FILE_NAME:${name}>" "${CPPM_PREFIX}/bin/$<TARGET_FILE_NAME:${name}>" DEPEND "${CPPM_PREFIX}/bin/$<TARGET_FILE_NAME:${name}>" COMMENT "make symblic link")
