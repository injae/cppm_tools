function(cppm_write_target_dependency_file)
    ...
    set(Deps "")
    get_target_property(deps ${PROJECT_NAME}_${name}_info CPPM_DEPENDENCIES)
...
function(cppm_target_install)
    ...
    list(GET ARG_UNPARSED_ARGUMENTS 0 name)
    if(TARGET ${name})
        get_target_property(_target_type ${PROJECT_NAME}_${name}_info CPPM_TYPE)
        if(_target_type MATCHES "BINARY")
            ...
            get_target_property(_namespace ${PROJECT_NAME}_${name}_info CPPM_NAMESPACE)
